...
For this project, I want to create a number of different visualizations and I will also be compiling them into a static dashboard (the interactive dashboard will come later!). 
